...
const Menu = () => {
    ...
    return (
        <nav className="menu menuHome">
            <ul>
                <li class="menuItem" id="missioLink" onClick={() => { handleClick("missio")} }>
                    <CustomLink 
                        href="/missio" 
                        content="La Mission" 
                        tag="NavLink"
                ...
                <li class="menuItem"  id="zonesLink" onClick={() => { handleClick("zones")} }>
                    <CustomLink 
                        href="/zones" 
                        content="Les Zones"
                        tag="NavLink"
                ...
                <li class="menuItem"  id="inventaireLink" onClick={() => { handleClick("inventaire")} }>
                    <CustomLink 
                        href="/inventaire" 
                ...
                <li class="menuItem"  id="coulissesLink" onClick={() => { handleClick("coulisses")} }>
                    <CustomLink 
                        href="/coulisses" 
