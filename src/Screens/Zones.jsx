...
const Zones = () => {
  ...
  const handleScroll = React.useCallback((e) => {
    drawAnchor(e);
    // PARALAXE
    document.querySelector('#zonesStars').style.top = `-${e.nativeEvent.srcElement.scrollTop / 10}px`;
    document.querySelector('#zonesDessin').style.top = `-${e.nativeEvent.srcElement.scrollTop / 10}px`;
    document.querySelector('#zonesConstelation').style.top = `-${e.nativeEvent.srcElement.scrollTop / 10}px`;
